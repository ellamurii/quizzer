...
export const questions: Array<Question> = [
  ...
  {
    question:
      "Who is known as the Father of Geography for being the first one to use the word geography and having a small-scale notion of the planet they helped him determine the circumference of the Earth?",
    options: [
      "Galileo Galilei (Astronomy & Physics)",
      "Nicolaus Copernicus (Astronomy & Physics)",
      "Eratosthenes",
  ...
  {
    question:
      "Which type of map is specifically designed to display elevation, contour lines, and physical features of the Earth's surface?",
    options: [
      "Topographic map",
      "Climactic map",
      "Political map",
  ...
  {
    question:
      "Who made the crucial breakthrough in understanding anthropogenic climate change in the late 19th century?",
    options: [
      "Samuel Pierpoint Langley",
      "Samuel Dierpo Stanley",
      "Richard Pierpoint Langley",
      "Richard Dierpo Stanley",
    ],
    answerIndex: 0,
  },
  {
    question:
      'Who authored the influential work "Silent Spring" in the 1960s, prompting significant changes in environmental policies and sparking research into the impact of human activities on the climate?',
    options: [
      "Albert Einstein",
      "Charles Roger Shuin",
  ...
  {
    question:
      "What is the average temperature of water in the Persian Gulf near the equator?",
    options: [
  ...
  {
    question:
      "Who developed the first reasonable theory of how the wind affects surface currents?",
    options: [
      "Jacques Cousteau",
      "Valfrid Ekman",
      "Marie Tharp",
  ...
  {
    question:
      "What Mountain range forms the boundary between the provinces of Negros Oriental and Negros Occidental in Region 7?",
    options: [
      "Negros Oriental Mountains",
      "Zambales Mountains",
      "Caraballo Mountains",
      "Mount Kanlaon",
    ],
  ...
  {
    question:
      "What term is used to refer to the standardized time that was formerly known as Greenwich Mean Time (GMT)?",
    options: [
      "Central Mean Time (CM)",
  ...
  {
    question:
      "At what degrees east or west is the International Date Line (IPL) positioned in relation to the prime meridian?",
    options: [
      "90 degrees west or east",
      "45 degrees west or east",
  ...
  {
    question:
      "What is the second-largest country in the world in terms of total area?",
    options: [
      "Russia (largest)",
      "Canada",
      "Brazil",
  ...
  },
  {
    ...
    options: [
      "Mount McKinley (highest/tallest peak as Mt. Denali)",
      "Badwater Basin (lowest point or Death Valley)",
      "Mount Logan",
  ...
  },
  {
    ...
    options: [
      "Rio Grande (border between USA and Mexico)",
      "Missouri River (flows through Central USA)",
  ...
  {
    question:
      "Which of the following best describes the formation of mountains?",
    options: [
      "Flat-topped elevated areas with steep sides, formed by geological processes such as erosion or volcanic activity.",
      "Large, flat areas of land with gentle slopes, often formed by sediment deposition or tectonic activity.",
  ...
  },
  {
    ...
    options: [
      "Elevated areas of land with rounded summits and lower elevation than mountains, often formed by erosion or tectonic activity.",
      "And regions characterized by low precipitation and low vegetation, formed due to factors such as rain shadow effects or continental interiors.",
      "Deep, narrow valleys with steep sides, usually formed by erosion from rivers or glaciers.",
      "Landmasses surrounded by water, ranging in size from small islets to large land masses.",
    ],
    answerIndex: 0,
  },
  {
    question: "Which of the following best describes the formation of deltas?",
    options: [
      "Landforms surrounded by water on three sides, typically connected to a larger landmass by a narrow strip of land. (Peninsula)",
      "Flat, low-lying landform at the mouth of rivers, formed by sediment deposition carried by rivers.",
  ...
  {
    question:
      'What geographical feature earned El Salvador the nickname "Land of Volcanoes?',
    options: [
      "Dense rainforest",
      "Numerous volcanoes",
      "Vat deserts",
  ...
  {
    question:
      "Which among the following volcanoes is considered the highest in Central America?",
    options: [
  ...
  {
    question:
      "What type of map shows the distribution of population density, indicating areas that are densely or sparsely populated?",
    options: [
      "Physical map",
      "Climate map",
      "Demographic map",
  ...
  {
    question:
      "Which map projection shows lines of longitude and latitude as straight lines meeting at right angles, making it easy to plot and read directions, and represents the shapes of areas on Earth?",
    options: [
  ...
  {
    question:
      "Who constructed the oldest globe in 1492 in Germany, which depicted the Old World after the discovery of the Americas?",
    options: ["Martin Behaim", "Ptolemy", "Eratosthenes", "Merijun De Diaz"],
    answerIndex: 0,
  },
  {
    question:
  ...
  {
    question:
      "What were the two major landmasses that resulted from the breakup of Pangea?",
    options: [
      "Pannotia and Gondi",
  ...
  {
    question:
      "What type of processes originate from external forces acting on the Earth's surface?",
    options: [
  ...
  {
    question:
      "What term describes the deformation of the Earth's crust caused by tectonic forces?",
    options: ["Diastrophism", "Erosion", "Subsidence", "Uplifting"],
    answerIndex: 0,
  },
  {
    question:
  ...
  {
    question:
      "Which term refers to smaller rivers or streams that flow into larger rivers, contributing water and sediment to the main river?",
    options: ["Tributaries", "Sea", "Gulf", "Bay"],
    answerIndex: 0,
  },
  {
    question:
  ...
  {
    question:
      "What is the name of the strait that separates the island of Cebu and Negros?",
    options: [
      "Guimaras Strait",
      "Tanon Strait",
  ...
  {
    question:
      "What Mountain range follows much of the east coast of the Philippines?",
    options: [
      "Sierra Madre",
      "Cordillera Central",
      "Zambales Mountains",
  ...
  {
    question:
      "What is the name of the volcano which is located on the small island of Camiguin?",
    options: [
      "Mt. Tibok-Tibok",
      "Mt. Kanlaon",
      "Mt. Visayan",
  ...
  {
    question:
      "What plateau, also referred to as Asia Minor, is renowned for its production of high-quality wool from Angora goats?",
    options: [
  ...
  {
    question:
      "Which body of water holds the distinction of being the largest lake globally in terms of both surface area and volume?",
    options: [
      "Huron lake (between USA and Canada)",
      "Caspian Sea",
  ...
  {
    question:
      "What geographical features in North Africa and characterized by its composition of black volcanic basalt?",
    options: [
      "The Jogiro",
      "The Atlas Plateau (Mountain North Africa)",
